          ...
          Open dialog
            ...
            >
                <DialogTitle id="customized-dialog-title" onClose={handleClose}>
                    <h4>Detalle de la factura <em>{factura.codigo}</em></h4>
                </DialogTitle>
                <DialogContent dividers>
                    <Grid container spacing={1}>
                        <Grid item xs={6}>
                            <Typography gutterBottom>
                                <b>Vendedor(a): </b> {factura.vendedor}
                            </Typography>
                        </Grid>
                        ...
                        <Grid item xs={4}>
                            <Typography gutterBottom>
                                <b>Fecha de compra:</b> {factura.fechaCompra}
                            </Typography>
                        </Grid>
                        <Grid item xs={4}>
                            <Typography gutterBottom>
                        ...
                        <Grid item xs={12}>
                            <Typography gutterBottom><b>Productos</b></Typography><br />
                            <FacturaProductosGrid productos={factura.productos} />
                        </Grid>
                        <Grid item xs={12}>
                            <Typography gutterBottom><b>Total IVA: </b><span>$ {factura.valorTotal}</span></Typography>
                        </Grid>
                        <Grid item xs={12}>
                            <Typography gutterBottom><b>Total Factura (IVA incluido): </b><span>$ {factura.valorTotal}</span></Typography>
                        </Grid>
                    </Grid>
                </DialogContent>
                <DialogActions>
